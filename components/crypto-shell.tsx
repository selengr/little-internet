...
export function CryptoShell({ fontVars }: { fontVars: string }) {
  return (
    <main
      className={`${fontVars} crypto-shell relative min-h-screen overflow-x-clip bg-[var(--cx-bg)] text-[var(--cx-fg)]`}
    >
      <style>{`
        .crypto-shell {
          --cx-bg: #f3f5f7;
          ...
          --cx-wash:
            radial-gradient(ellipse 70% 48% at 0% 0%, rgba(143, 184, 0, 0.12), transparent 55%),
