  ...
  return (
    <div className="bg-background text-foreground min-h-screen font-sans antialiased overflow-x-clip">
      ...
      <section className="relative overflow-hidden border-t border-border px-6 py-24 md:px-12 md:py-32 lg:px-20">
        {/* Larger AVIF — https___west.avif is tiny and often blank on mobile */}
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src="/images/banners/s3-us-west-2.avif"
          alt=""
          aria-hidden="true"
          decoding="async"
          ...
          style={{ opacity: 0.9 }}
        />
        {/* Soft blur only on the lower band — not a full wipe */}
        <div
          className="pointer-events-none absolute inset-x-0 bottom-0 h-[55%] md:h-[60%]"
          style={{
            maskImage: "linear-gradient(to top, black 0%, transparent 100%)",
        ...
        />
        {/* Light fade into page bg — keeps mountains visible on small screens */}
        <div
          className="pointer-events-none absolute inset-0 dark:hidden"
          style={{
            background:
              "linear-gradient(to top, rgb(245,244,240) 0%, rgba(245,244,240,0.55) 14%, rgba(245,244,240,0.18) 32%, transparent 58%)",
          }}
        />
        <div className="pointer-events-none absolute inset-0 hidden bg-gradient-to-t from-background from-0% via-background/35 via-28% to-transparent to-60% dark:block" />
